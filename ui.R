    ...
    dashboardBody(
      tabItems(
        ...
        tabItem(tabName = "PrimerEvaluation",
                h2(HTML("<b><span style='color:#51A262;'>Primer Evaluation</span></b>"))  ,
                fluidRow(
        ...
        tabItem(tabName = "Links",
                h2(HTML("<b><span style='color:#51A262;'>Primer Tools</span></b>"))  ,
                fluidRow(
                  box(solidHeader = TRUE,
                      collapsible = TRUE,
                      h3(HTML("<b><span style='color:#51A262;'>Primer3web</span></b>"))  ,
                      h4(HTML("<span style='color:#51A262;'>https://primer3.ut.ee/</span>"))  ,
                      h5("an integrating masking of template sequence with primer design software.")),
                  box(solidHeader = TRUE,
                      collapsible = TRUE,
                      h3(HTML("<b><span style='color:#51A262;'>MFEprimer</span></b>"))  ,
                      h4(HTML("<span style='color:#51A262;'>https://www.mfeprimer.com/</span>"))  ,
                ...
                fluidRow(
                  box(solidHeader = TRUE,
                      collapsible = TRUE,
                      h3(HTML("<b><span style='color:#51A262;'>primalscheme</span></b>"))  ,
                      h4(HTML("<span style='color:#51A262;'>https://primalscheme.com/</span>"))  ,
                  ...
                  box(solidHeader = TRUE,
                      collapsible = TRUE,
                      h3(HTML("<b><span style='color:#51A262;'>Oligo</span></b>"))  ,
                      h4(HTML("<span style='color:#51A262;'>https://www.oligo.net/</span>"))  ,
                ...
                fluidRow(
                  box(solidHeader = TRUE,
                      collapsible = TRUE,
                      h3(HTML("<b><span style='color:#51A262;'>qPrimerDB</span></b>"))  ,
                      h4(HTML("<span style='color:#F51A262;'>https://qprimerdb.biodb.org</span>"))  ,
                  ...
                  box(solidHeader = TRUE,
                      collapsible = TRUE,
                      h3(HTML("<b><span style='color:#51A262;'>Primer Biosoft</span></b>"))  ,
                      h4(HTML("<span style='color:#F51A262;'>http://www.premierbiosoft.com/</span>"))  ,
